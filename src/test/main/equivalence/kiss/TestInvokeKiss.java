...
public class TestInvokeKiss {
    ...
    public void invokeKiss() throws Exception {
        ...
        // TODO: Fix
//        String output = KissEngine.invoke(COMMAND, QUERRY_1);
//        List<DeductionResult> deductionResults = KissEngine.getDeductionResults(output);
//        List<EquivalenceResult> equivalenceResults = KissEngine.getEquivalenceResults(output);
//
